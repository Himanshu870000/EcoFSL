            ...
            if(response.getState() === 'SUCCESS'){
                ...
                if(result != null){
                    ...
                    var cardData = [
                        ...
                        { Title: 'Existing To Business', Description: '' ,cl: '#62b7ed' ,Padding: '2%' ,View: 'View' ,listviewId: '00B0T000001iTmFUAU',wi:'70%' ,ml:'14%' ,br:'8px' ,mr:'0%'},
                        { Title: 'New To Business', Description: '' ,cl: '#62b7ed' ,Padding: '2%' ,View: 'View' ,listviewId: '00B0T000001iTmKUAU',wi:'70%' ,ml:'14%' ,br:'8px' ,mr:'0%'},
                        { Title: 'Lost Clients', Description: '' ,cl: '#62b7ed' ,Padding: '2%' ,View: 'View' ,listviewId: '00B0T000001iTmPUAU',wi:'70%' ,ml:'14%' ,br:'8px' ,mr:'-1%'}
                    ];
                    var temparray = [];
